        ...
        <c:forEach var="list" items="${StrayAnimalList}">
            ...
            <div class="stray-card">
                ...
                <div class="card-admin-bar">
                	<button type="button" class="card-delete-btn" onclick="if(confirm('정말 수정 하시겠습니까?')){location.href='/strayUpdateForm?stray_no=${list.stray_no}';}">
                        업데이트
                    </button>
                    <button type="button" class="card-delete-btn" onclick="if(confirm('정말 삭제 하시겠습니까?')){location.href='/StrayAnimalDelete?stray_no=${list.stray_no}';}">
                        삭제
                    </button>
                </div>
            </div>
